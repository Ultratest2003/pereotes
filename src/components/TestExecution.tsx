...
const TestExecution: React.FC<TestExecutionProps> = ({ testId, accessCode, userName, onComplete }) => {
  console.log('TestExecution component rendering with:', { testId, accessCode, userName });
  ...
  // Then get questions for that test
      ...
      <Card>
        <CardContent className="pt-6">
          <p className="text-center text-muted-foreground">
            Для этого теста пока нет вопросов
          </p>
        </CardContent>
      </Card>
    );
    ...
    <>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Участник: {userName} | Код: {accessCode}
          </CardDescription>
        </CardHeader>
      ...
      <Dialog open={showResults} onOpenChange={setShowResults}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Участник: {userName} | Код доступа: {accessCode}
            </DialogDescription>
          </DialogHeader>
          {testResults && (
